...
CREATE TABLE `t_goods` (
  ...
  `goods_stock` int(11) DEFAULT '0' COMMENT '商品库存,-1表示无穷',
  PRIMARY KEY (`id`)
...
(1,'IPHONE12','IPHONE12 64GB','/img/iphone12.png','iphone12 64g',6299.00,100),
(2,'IPHONE12 PRO','IPHONE12 PRO 128GB','/img/iphone12pro.png','iphone12 pro 128g',9299.00,100);
...
(12,18012345678,1,0,'IPHONE12',1,629.00,1,0,'2021-01-30 12:25:04',NULL),
(13,18012345678,1,0,'IPHONE12',1,629.00,1,0,'2021-01-30 12:34:03',NULL);
...
(1,1,629.00,8,'2021-01-30 01:30:00','2021-01-30 13:00:00'),
(2,2,929.00,10,'2020-11-11 08:00:00','2020-11-11 09:00:00');
